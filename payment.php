...
<html>
  ...
  <head>
    <title> Cart | Gourmet's Bite </title>
  </head>
  ...
  <style>
    body {
      background-image: url('images/payment_page.png'); /* Provide the correct path to your image */
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <br>
<h1 class="text-center">Grand Total: Rs:<?php echo "$gtotal"; ?>/-</h1>

...
<html>
  ...
  <head>
    <title> Contact | Gourmet's Bite </title>
  </head>
  ...
  <style>
    body {
      background-image: url('images/contactus_back.jpg'); /* Provide the correct path to your image */
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Gourmet's Bite </span>?</strong>
     <br>
